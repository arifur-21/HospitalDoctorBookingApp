...
import com.example.hospitalmagapp.adapter.DoctorSpecialitiesAdapter
...
class AppointedPatientFragment : Fragment() {
    private lateinit var specialitiesAdapter: DoctorSpecialitiesAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_appointed_patient, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        specialitiesAdapter = DoctorSpecialitiesAdapter(requireContext(), specialistList)
