...
class SpecialitiesAdapter(var context: Context, var specialitiesList: ArrayList<SpecialitiesModel>):
       ...
       val data = specialitiesList[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            bundle.putString("type",data.type)
                Navigation.findNavController(it).navigate(R.id.action_specialitiesFragment_to_doctorListFragment, bundle)
